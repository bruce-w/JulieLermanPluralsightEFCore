...
namespace Tests
{
    ...
    public class UnitTest1
    {
        ...
        {
            var inMemoryOptions = new DbContextOptionsBuilder<SamuraiContext>().UseInMemoryDatabase("QueryWithFunction").Options;
            ...
            var battles = context.Battles
                ...
                {
                    b.Name,
                    Days = context.DaysInBattle(b.StartDate, b.EndDate)
                })
                .ToList();
